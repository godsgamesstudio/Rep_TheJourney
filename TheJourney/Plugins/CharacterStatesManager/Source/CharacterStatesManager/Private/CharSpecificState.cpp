...
bool UCharSpecificState::VerifySpecificState()
{
...
bool UCharSpecificState::StartCondition_Implementation()
{
    return false;
}

bool UCharSpecificState::GetCanCharacterMove()
{
    return CanCharacterMove;
}

bool UCharSpecificState::GetCanSwitchProfile()
{
    return CanSwitchProfile;
}